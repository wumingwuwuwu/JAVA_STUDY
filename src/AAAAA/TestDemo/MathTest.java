...
public class MathTest
{
    public static void main (String[] args){
        ...
        //取整，返回大于目标数的最小整数
        System. out .println("Math.ce11(1.2):"+ Math.ceil(1.2));
        //四舍五入取整
        ...
        //计算自然对数
        System.out.println("Math.1og(12):"+ Math.log(12));
        //计算底数为10的对数
        System. out .println("Math.1og10(9):"+ Math.log10(9));
        //返回参数与1之和的自然对数
        System .out.println ("Math.1og1p(9): "+ Math.log1p(9));
        /*--------下面是符号相关的运算--------*/
        //计算绝对值
        ...
        //则返回1.0如果参数小于0,则返回-1.0
        System.out.println("Math.signum(2.3)"+ Math.signum(2.3)) ;
        /*---------下面是大小相关的远算-------*/
        //找出最大值
        System.out.println ("Math.max(2.3，4.51:"+ Math.max(2.3,4.51));
        //计算最小值
        ...
        System.out.println("Math.randomn()"+ Math. random()) ;
    }
}